    ...
    <div class="row">
      ...
      <c:forEach var="recipe" items="${recipes}">
        <div class="col-4 my-2">
          <a href="recipe?id=${recipe.getId()}" class="no-underline link">
            <div class="card">
